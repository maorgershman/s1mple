...
export struct Key
{
  ...
  [[nodiscard]] bool is_currently_pressed() const noexcept
  {
...
#define DEFINE_KEY(x) export constexpr Key x { VirtualKey::x, #x }
...
#define CHECK_KEY(name) if (str == #name) return name
